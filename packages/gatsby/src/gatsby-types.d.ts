...
type WpContentType = Node & WpNode & WpUniformResourceIdentifiable & {
  /** La ruta de la URL de la primera página de la página de archivo para este tipo de contenido. */
...
/** The template assigned to the node */
type WpTemplate_BlogAlternativo = WpContentTemplate & {
  /** The name of the template */
  readonly templateName: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
type WpTemplate_EnBlanco = WpContentTemplate & {
  /** The name of the template */
  readonly templateName: Maybe<Scalars['String']>;
};
...
type WPPostArchiveQueryVariables = Exact<{ [key: string]: never; }>;


type WPPostArchiveQuery = { readonly wp: { readonly readingSettings: { readonly postsPerPage: number | null } | null } | null };

type WpPostsQueryVariables = Exact<{ [key: string]: never; }>;


type WpPostsQuery = { readonly allWpPost: { readonly edges: ReadonlyArray<{ readonly previous: { readonly id: string } | null, readonly post: { readonly id: string, readonly uri: string | null }, readonly next: { readonly id: string } | null }> } };
